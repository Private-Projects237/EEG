function result = clean_dry_erp_result_struct(fileName)
    ...
    result.TotalTrials = NaN;
    result.StartingChan = NaN;
    result.InitialRecordingLenMin = NaN;
    result.InitialMarkers = '-';
    result.RemainingRecordingLenMin = NaN;
    result.RemainingMarkers = '-';
    result.BandPassFilt = '-';
