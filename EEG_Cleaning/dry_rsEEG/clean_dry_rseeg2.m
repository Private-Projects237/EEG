...
function clean_dry_rseeg2(eegFiles, EEG_Pathway, EEG_save_path, EEG_csv_save_path, preprocParams, batchSize)
    ...
    for startIdx = 1:batchSize:numFiles
        ...
        parfor i = 1:length(currentBatch)
            ...
            try
                ...
                % === Calculate ASR-Altered Data Proportion ===
                EEG_cleaned_asr = EEG; 
                ...
                % === Re-referencing ===
                reRefLabels = {EEG.chanlocs(preprocParams.reRef.chan).labels};
